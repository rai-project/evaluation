...
type AutoGenerated struct {
	TensorDescription struct {
		...
		AllocationDescription struct {
			...
			Ptr            int64  `json:"ptr"`
		} `json:"allocation_description"`
	} `json:"tensor_description"`
}
...
func getAllocationBytes(span model.Span) int64 {
	...
	// fmt.Println(result[0].AllocationDescription.AllocatedBytes)
