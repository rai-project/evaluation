...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation7(in *jlexer.Lexer, out *SummaryLayerMemoryInformations) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation7(out *jwriter.Writer, in SummaryLayerMemoryInformations) {
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation8(in *jlexer.Lexer, out *SummaryLayerLatencyInformations) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation8(out *jwriter.Writer, in SummaryLayerLatencyInformations) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation9(in *jlexer.Lexer, out *SummaryLayerInformations) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation9(out *jwriter.Writer, in SummaryLayerInformations) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation10(in *jlexer.Lexer, out *SummaryLayerInformation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "durations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v84 int64
					v84 = int64(in.Int64())
					out.Durations = append(out.Durations, v84)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "allocated_bytes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v85 int64
					v85 = int64(in.Int64())
					out.AllocatedBytes = append(out.AllocatedBytes, v85)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "peak_allocated_bytes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v86 int64
					v86 = int64(in.Int64())
					out.PeakAllocatedBytes = append(out.PeakAllocatedBytes, v86)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "allocator_bytes_in_use":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v87 int64
					v87 = int64(in.Int64())
					out.AllocatorBytesInUse = append(out.AllocatorBytesInUse, v87)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "host_temp_mem_bytess":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v88 int64
					v88 = int64(in.Int64())
					out.HostTempMemSizes = append(out.HostTempMemSizes, v88)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "device_temp_mem_bytess":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v89 int64
					v89 = int64(in.Int64())
					out.DeviceTempMemSizes = append(out.DeviceTempMemSizes, v89)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "host_persistent_mem_bytess":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v90 int64
					v90 = int64(in.Int64())
					out.HostPersistentMemSizes = append(out.HostPersistentMemSizes, v90)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "device_persistent_mem_bytess":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v91 int64
					v91 = int64(in.Int64())
					out.DevicePersistentMemSizes = append(out.DevicePersistentMemSizes, v91)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation10(out *jwriter.Writer, in SummaryLayerInformation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Index != 0 {
	...
	if len(in.Durations) != 0 {
		...
		{
			out.RawByte('[')
			for v92, v93 := range in.Durations {
				if v92 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v93))
	...
	if len(in.AllocatedBytes) != 0 {
		...
		{
			out.RawByte('[')
			for v94, v95 := range in.AllocatedBytes {
				if v94 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v95))
	...
	if len(in.PeakAllocatedBytes) != 0 {
		...
		{
			out.RawByte('[')
			for v96, v97 := range in.PeakAllocatedBytes {
				if v96 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v97))
	...
	if len(in.AllocatorBytesInUse) != 0 {
		...
		{
			out.RawByte('[')
			for v98, v99 := range in.AllocatorBytesInUse {
				if v98 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v99))
	...
	if len(in.HostTempMemSizes) != 0 {
		...
		{
			out.RawByte('[')
			for v100, v101 := range in.HostTempMemSizes {
				if v100 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.DeviceTempMemSizes) != 0 {
		...
		{
			out.RawByte('[')
			for v102, v103 := range in.DeviceTempMemSizes {
				if v102 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.HostPersistentMemSizes) != 0 {
		...
		{
			out.RawByte('[')
			for v104, v105 := range in.HostPersistentMemSizes {
				if v104 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.DevicePersistentMemSizes) != 0 {
		...
		{
			out.RawByte('[')
			for v106, v107 := range in.DevicePersistentMemSizes {
				if v106 > 0 {
					out.RawByte(',')
				}
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation13(in *jlexer.Lexer, out *SummaryLayerAggreInformation) {
	...
	for !in.IsDelim('}') {
		...
		case "allocated_memory":
			out.AllocatedMemory = int64(in.Int64())
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation13(out *jwriter.Writer, in SummaryLayerAggreInformation) {
	...
	if in.AllocatedMemory != 0 {
		...
		out.Int64(int64(in.AllocatedMemory))
	}
