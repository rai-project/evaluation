...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation16(in *jlexer.Lexer, out *LayerInformations) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation16(out *jwriter.Writer, in LayerInformations) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation17(in *jlexer.Lexer, out *LayerInformation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation17(out *jwriter.Writer, in LayerInformation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation18(in *jlexer.Lexer, out *KernelLaunchInformation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation18(out *jwriter.Writer, in KernelLaunchInformation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
