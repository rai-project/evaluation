...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation6(out *jwriter.Writer, in SummaryPredictAccuracyInformation) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation7(in *jlexer.Lexer, out *SummaryModelInformation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation7(out *jwriter.Writer, in SummaryModelInformation) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Durations) != 0 {
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation9(in *jlexer.Lexer, out *SummaryLayerInformations) {
	...
	if in.IsNull() {
		...
		*out = nil
		...
		for !in.IsDelim(']') {
			var v45 SummaryLayerInformation
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation12(in *jlexer.Lexer, out *SummaryCUDALaunchInformation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "kernel_launch_information":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v53 KernelLaunchInformation
					(v53).UnmarshalEasyJSON(in)
					out.KernelLaunchInformations = append(out.KernelLaunchInformations, v53)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation12(out *jwriter.Writer, in SummaryCUDALaunchInformation) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.KernelLaunchInformations) != 0 {
		...
		{
			out.RawByte('[')
			for v54, v55 := range in.KernelLaunchInformations {
				if v54 > 0 {
					out.RawByte(',')
				}
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation13(in *jlexer.Lexer, out *SummaryBase) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation13(out *jwriter.Writer, in SummaryBase) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation14(in *jlexer.Lexer, out *RuntimeMemoryInformation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation14(out *jwriter.Writer, in RuntimeMemoryInformation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.StartAlloc != 0 {
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation15(in *jlexer.Lexer, out *Performance) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation15(out *jwriter.Writer, in Performance) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
	...
	for !in.IsDelim('}') {
		...
		case "gpu":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v56 GPUMemInformation
					(v56).UnmarshalEasyJSON(in)
					out.GPU = append(out.GPU, v56)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation17(in *jlexer.Lexer, out *MeanLayerInformations) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation17(out *jwriter.Writer, in MeanLayerInformations) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation18(in *jlexer.Lexer, out *LayerInformations) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation18(out *jwriter.Writer, in LayerInformations) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
		for v63, v64 := range in {
			if v63 > 0 {
				out.RawByte(',')
			}
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation19(in *jlexer.Lexer, out *LayerInformation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "durations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Durations = append(out.Durations, v65)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation19(out *jwriter.Writer, in LayerInformation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Index != 0 {
...
func easyjson679db3deDecodeGithubComRaiProjectEvaluation20(in *jlexer.Lexer, out *KernelLaunchInformation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation20(out *jwriter.Writer, in KernelLaunchInformation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
	...
	if len(in.Tags) != 0 {
		...
		{
			out.RawByte('[')
			for v73, v74 := range in.Tags {
				if v73 > 0 {
					out.RawByte(',')
				}
				if v74 == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
					out.RawString(`null`)
				} else {
					out.RawByte('{')
					v75First := true
					for v75Name, v75Value := range v74 {
						if v75First {
							v75First = false
						} else {
							out.RawByte(',')
	...
	if len(in.Logs) != 0 {
		...
		{
			out.RawByte('[')
			for v76, v77 := range in.Logs {
				if v76 > 0 {
					out.RawByte(',')
				}
				if v77 == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
					out.RawString(`null`)
				} else {
					out.RawByte('{')
					v78First := true
					for v78Name, v78Value := range v77 {
						if v78First {
							v78First = false
						} else {
							out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "input_prediction_ids":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v81 bson.ObjectId
					if data := in.Raw(); in.Ok() {
						in.AddError((v81).UnmarshalJSON(data))
					}
					out.InputPredictionIDs = append(out.InputPredictionIDs, v81)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson679db3deEncodeGithubComRaiProjectEvaluation22(out *jwriter.Writer, in Evaluation) {
	...
	if len(in.InputPredictionIDs) != 0 {
		...
		{
			out.RawByte('[')
			for v83, v84 := range in.InputPredictionIDs {
				if v83 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Metadata) != 0 {
		...
		}
		{
			out.RawByte('{')
			v85First := true
			for v85Name, v85Value := range in.Metadata {
				if v85First {
					v85First = false
				} else {
					out.RawByte(',')
	...
	for !in.IsDelim('}') {
		...
		case "container":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v86 *dlframework.ContainerHardware
					if in.IsNull() {
						in.Skip()
						v86 = nil
					} else {
						if v86 == nil {
							v86 = new(dlframework.ContainerHardware)
						}
						easyjson679db3deDecodeGithubComRaiProjectDlframework2(in, v86)
					}
					(out.Container)[key] = v86
					in.WantComma()
				}
				in.Delim('}')
			}
		...
		case "reference":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Reference = append(out.Reference, v87)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "inputs":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v88 *dlframework.ModelManifest_Type
					if in.IsNull() {
						in.Skip()
						v88 = nil
					} else {
						if v88 == nil {
							v88 = new(dlframework.ModelManifest_Type)
						}
						easyjson679db3deDecodeGithubComRaiProjectDlframeworkModelManifest(in, v88)
					}
					out.Inputs = append(out.Inputs, v88)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson679db3deEncodeGithubComRaiProjectDlframework1(out *jwriter.Writer, in dlframework.ModelManifest) {
	...
	if len(in.Container) != 0 {
		...
		}
		{
			out.RawByte('{')
			v90First := true
			for v90Name, v90Value := range in.Container {
				if v90First {
					v90First = false
				} else {
					out.RawByte(',')
				...
				if v90Value == nil {
					...
					easyjson679db3deEncodeGithubComRaiProjectDlframework2(out, *v90Value)
				}
			}
			out.RawByte('}')
		}
	...
	if len(in.Reference) != 0 {
		...
		{
			out.RawByte('[')
			for v91, v92 := range in.Reference {
				if v91 > 0 {
					out.RawByte(',')
				}
		...
		}
		{
			...
			for v93, v94 := range in.Inputs {
				...
				if v94 == nil {
					...
					easyjson679db3deEncodeGithubComRaiProjectDlframeworkModelManifest(out, *v94)
				}
			}
			out.RawByte(']')
		}
	...
	if len(in.Attributes) != 0 {
		...
		}
		{
			out.RawByte('{')
			v95First := true
			for v95Name, v95Value := range in.Attributes {
				if v95First {
					v95First = false
				} else {
					out.RawByte(',')
		...
		case "parameters":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v96 *dlframework.ModelManifest_Type_Parameter
					if in.IsNull() {
						in.Skip()
						v96 = nil
					} else {
						if v96 == nil {
							v96 = new(dlframework.ModelManifest_Type_Parameter)
						}
						easyjson679db3deDecodeGithubComRaiProjectDlframeworkModelManifestType(in, v96)
					}
					(out.Parameters)[key] = v96
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson679db3deEncodeGithubComRaiProjectDlframeworkModelManifest(out *jwriter.Writer, in dlframework.ModelManifest_Type) {
	...
	if len(in.Parameters) != 0 {
		...
		}
		{
			out.RawByte('{')
			v97First := true
			for v97Name, v97Value := range in.Parameters {
				if v97First {
					v97First = false
				} else {
					out.RawByte(',')
				...
				if v97Value == nil {
					...
					easyjson679db3deEncodeGithubComRaiProjectDlframeworkModelManifestType(out, *v97Value)
				}
			}
			out.RawByte('}')
		}
		...
		case "container":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v98 *dlframework.ContainerHardware
					if in.IsNull() {
						in.Skip()
						v98 = nil
					} else {
						if v98 == nil {
							v98 = new(dlframework.ContainerHardware)
						}
						easyjson679db3deDecodeGithubComRaiProjectDlframework2(in, v98)
					}
					(out.Container)[key] = v98
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson679db3deEncodeGithubComRaiProjectDlframework(out *jwriter.Writer, in dlframework.FrameworkManifest) {
	...
	if len(in.Container) != 0 {
		...
		}
		{
			out.RawByte('{')
			v99First := true
			for v99Name, v99Value := range in.Container {
				if v99First {
					v99First = false
				} else {
					out.RawByte(',')
				...
				if v99Value == nil {
					...
					easyjson679db3deEncodeGithubComRaiProjectDlframework2(out, *v99Value)
				}
			}
			out.RawByte('}')
		}
