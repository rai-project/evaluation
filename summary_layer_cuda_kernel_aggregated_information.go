...
// //easyjson:json
// type SummaryLayerGPUAggregatedInformation struct {
// 	SummaryLayerCUDAKernelInformation `json:",inline"`
// 	GPUDuration                       float64 `json:"gpu_duration,omitempty"`
// 	CPUDuration                       float64 `json:"cpu_duration,omitempty"`
// 	Flops                             int64   `json:"flops,omitempty"`
// 	DramReadBytes                     int64   `json:"dram_read_bytes,omitempty"`
// 	DramWriteBytes                    int64   `json:"dram_write_bytes,omitempty"`
// }

// //easyjson:json
// type SummaryLayerGPUInformations []SummaryLayerGPUInformation
