...
#go build main.go
./main latency		--append --model_name all -f json --database_name tx2_carml_step_trace &
./main layers	 	--append --model_name all -f json --database_name tx2_carml_full_trace &
./main layer_tree	--append --model_name all -f json --database_name tx2_carml_full_trace &
