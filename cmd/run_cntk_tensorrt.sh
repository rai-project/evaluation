...
#go build main.go
./main latency --framework_name TensorRT	--append --model_name all -f json --database_name carml_step_trace &
...
./main latency --framework_name CNTK	--append --model_name all -f json --database_name carml_step_trace &
